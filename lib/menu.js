    ...
    switch ( choice ) {
      ...
      case 'V':
        pass.sord.util.userinfo(pass, function() {
          setTimeout(pass.sord.menuwait,0,pass,pass.sord.menuctrl.town,pass.sord.menus.town,[pass]);
        }); break;
      case 'L':
        pass.outBuff.queue(pass.sord.util.listUsers(pass));
        pass.sord.pause(pass, function() {
      ...
      case 'X':
        ...
        break;
      case '?':
        setTimeout(pass.sord.menuwait,0,pass,pass.sord.menuctrl.town,pass.sord.menus.town,[pass,false]);
        break;
      default:
        setTimeout(pass.sord.menuwait,0,pass,pass.sord.menuctrl.town,pass.sord.menus.town,[pass,true]);
        break;
    }
  },
}
